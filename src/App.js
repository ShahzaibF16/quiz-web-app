  ...
  const questions = [
    {
      ...
      answerOptions: [
        ...
        { answerText: 'Asif Ali Zardari', isCorrect: false },
        { answerText: 'Shehbaz Sharif', isCorrect: true },
        { answerText: 'Nawaz Sharif', isCorrect: false },
      ],
    },
    {
      questionText: 'The border between Pakistan and Afghanistan is called?',
      answerOptions: [
        { answerText: 'Radcliffe Line', isCorrect: false },
        { answerText: 'Ceasefire Line', isCorrect: false },
        { answerText: 'Durand Line', isCorrect: true },
        { answerText: 'Peace Line', isCorrect: false },
      ],
    },
    {
